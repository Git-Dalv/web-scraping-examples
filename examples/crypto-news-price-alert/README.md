...
│   │   └── save\_to.py           # Report generation (Markdown, JSON)
...
&nbsp; - `find\_price\_changes()`: Detects movements exceeding threshold

&nbsp; - `news\_analysis()`: Cleans and deduplicates news articles

&nbsp; - `convert\_to\_df()`: Utility for DataFrame conversion
...
&nbsp; - `save\_digest\_markdown()`: Human-readable report with price movements and news

&nbsp; - `create\_comprehensive\_json\_report()`: Structured JSON with all monitored coins
...
COINGECKO\_API\_KEY=your\_coingecko\_api\_key\_here

API\_KEY2=your\_coindesk\_api\_key\_here
...
\*\*JSON Report\*\* (`reports/comprehensive\_report\_YYYYMMDD\_HHMMSS.json`)
...
&nbsp; "generated\_at": "2025-12-15T14:30:00Z",

&nbsp; "threshold\_percent": 5.0,

&nbsp; "summary": {

&nbsp;   "total\_coins\_monitored": 15,

&nbsp;   "coins\_with\_alerts": 4,

&nbsp;   "coins\_normal": 11,

&nbsp;   "total\_news\_articles": 8
...
&nbsp; max\_requests: 30      # Requests per time window

&nbsp; time\_window: 60.0     # Time window in seconds
...
\- Adjust `rate\_limit` in YAML configs
